...
/**
 ...
 Camera preview, face boxes, and tracking live in GazeCamera (native SDK snapshot).
 */
...
final class GazePreviewFactory: NSObject, FlutterPlatformViewFactory {
    ...
    func create(
        ...
        GazePreviewPlatformView(frame: frame, preview: plugin?.previewView())
    }
}

final class GazePreviewPlatformView: NSObject, FlutterPlatformView {
    private let container: UIView

    init(frame: CGRect, preview: GazePreviewView?) {
